...
import Adriel from '../../assets/images/collabs/Adriel.jpeg';
...
const people = [
    ...
    createPeople('Lisbeth Santos', 'Ilustradora y loca por los videojuegos. Encargada del manejo de redes sociales y la organización en sí del programa. A su vez forma parte esencial en la búsqueda de patrocinios.', Lisbeth, 'https://www.instagram.com/lsantosart/'),
    ...
    createPeople('Salma Alegre', 'Ilustradorx y diseñadxr gráfico, encargadx de la creación y desenvolvimiento de la línea gráfica de este año.', Salma, 'https://www.instagram.com/darkjellyfishart/'),
    ...
    createPeople('Adriel Vargas', 'Ingeniero en sonido y diseñador gráfico, le gusta hacer efectos de sonidos y música con un grado de experimentación.', Adriel, null),
]
            ...
            <div className='flex row wrap justify_around collabs'>
                {
                    people.map(p => {
                        return (
                            <div className='flex column center collabs_container' key={p.Name}>
                                <div
                                    style={{
                                    ...
                                    onClick={() => {
                                        ...
                                        window.open(p.Enlace);
                                    }}
                                    className='pointer collaborator'
                                />
                                <p className='no_margin font_amsi collabs_name center text_white'>{p.Name}</p>
                                <p className='no_margin font_brandon collabs_description  text_white collapsible'>{p.Description}</p>
                            </div>
                        );
                    })
                }
